#task:- To create a feet to meter conversion in python.
#Developer By:- Arshad khan
...
#label for meter
mt_lbl=Label(window, text='Meter', bg='dark red',fg='white',width=14)
...
#convert
convert_btn = Button(window, text='Convert',bg='dark blue',fg='white',width=14,command=convert)
